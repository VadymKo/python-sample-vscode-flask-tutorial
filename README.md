[![Build Status](https://dev.azure.com/vkundenchuk/vdm-test-project/_apis/build/status/VadymKo.python-sample-vscode-flask-tutorial?branchName=master)](https://dev.azure.com/vkundenchuk/vdm-test-project/_build/latest?definitionId=1&branchName=master)
